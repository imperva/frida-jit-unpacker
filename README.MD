...
The sofware requires an active Internet connection.
...
## Telemetry
The tool collects basic telemetry regarding execution in order to improve its efficiency in the future. (file size, header information, file hashes ...)
